...
export default function HomePageListBox () {
    ...
    return (
        <div
            ...
            <div className="h-56 w-full">
                <a href="#">
                    <video
                        ...
                        src="https://res.cloudinary.com/djlee4yl2/video/upload/v1723202315/gopfuv3zx2kmoqnn13fh.mp4"
                        poster="https://res.cloudinary.com/djlee4yl2/video/upload/so_5/v1723202315/gopfuv3zx2kmoqnn13fh.jpg"
                        alt="Video thumbnail"
                        controls
                    >
            ...
            <div className="pt-6">
                ...
                <a href="#"
                   className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Microsoft
